...
setup(
    ...
    install_requires=[
        ...
        "imageio==2.28.1; python_version >= '3.4'",
        "imageio-ffmpeg==0.4.8; python_version >= '3.4'",
        "moviepy==1.0.3",
        "numpy==1.24.3; python_version >= '2.7'",
        "oauth2client==4.1.3",
        "oauthlib==3.2.2; python_version >= '3.6'",
        "pillow==9.5.0; python_version >= '3.7'",
        "proglog==0.1.10",
        "progressbar2==4.2.0; python_full_version >= '3.7.0'",
        "protobuf==4.23.0; python_version >= '3.7'",
    ...
    #
    dependency_links=[
        "git+https://github.com/tokland/youtube-upload@6a30b55d0fd4976571a5b9b34c01fd41cec49c7a#egg=youtube-upload"
    ],
